...
window.$ = window.jQuery = require('jquery')
        ...
        // <!-- Project Pools Tab JS -->
            ...
            function openV3_ProjectPool(evt, cityName) {
                ...
                tabcontent = document.getElementsByClassName("v3_ProjectPools_tabcontent");
                for (i = 0; i < tabcontent.length; i++) {
                    tabcontent[i].style.display = "none";
                }
                tablinks = document.getElementsByClassName("V3_ProjectPool_tablinks");
        ...
        // <!-- Our Partnars Tab JS -->  
            ...
            function openV3_OurPartnars(evt, cityName) {
                var i, tabcontent, tablinks;
                tabcontent = document.getElementsByClassName("v3_OurPartnars_tabcontent");
                for (i = 0; i < tabcontent.length; i++) {
                    tabcontent[i].style.display = "none";
                }
                tablinks = document.getElementsByClassName("v3_OurPartnars_tablinks");
                for (i = 0; i < tablinks.length; i++) {
                    tablinks[i].className = tablinks[i].className.replace(" active", "");
                }
                document.getElementById(cityName).style.display = "block";
